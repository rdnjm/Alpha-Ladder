...
st.markdown(
    "Why the internal radius a₀ is NOT determined by the minimal 6D EH+GB "
...
if summary:
    ...
    st.markdown(
        ...
        in 2D equals 4πχ (Gauss-Bonnet theorem): topological.
        Therefore a₀ is a flat direction of the tree-level action.
        </div>
        """,
        unsafe_allow_html=True,
    )
...
if summary:
    ...
    st.markdown(
        ...
        <b>Mechanisms that could fix a₀:</b><br><br>
...
if summary:
    ...
    st.markdown(
        ...
        V_min(a₀) is monotonically decreasing (scales as a₀⁻⁴).
        No finite a₀ minimizes the vacuum energy. The internal radius
...
if summary:
    ...
    st.markdown(
        """
        <div class="formula-card">
        <b>Landscape (a₀ = l_Pl):</b><br><br>
        At Planck-scale a₀, ALL flux quanta N = 1..10 produce Planck-scale
        dilaton masses. The dilaton is invisible at all experimental scales.
        To get sub-Planck masses requires a₀ >> l_Pl.
        </div>
        """,
        unsafe_allow_html=True,
    )
...
if summary:
    ...
    st.markdown(
        ...
        The internal radius a₀ is NOT determined by the minimal 6D EH+GB
        ...
        conditional predictions: IF a₀ is in the sub-mm range, specific
